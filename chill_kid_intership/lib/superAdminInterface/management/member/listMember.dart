...
import 'package:chill_kid_intership/superAdminInterface/management/member/add_member.dart';
import 'package:chill_kid_intership/superAdminInterface/management/member/memberDetail.dart';
    ...
    return Scaffold(
      ...
      body: Container(
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (BuildContext context,int index){
                      ...
                      return GestureDetector(
                        onTap: (){
                          Navigator.push(context,new MaterialPageRoute(builder: (context)=>memberDetail(snapshot.data[index])));
                        },
                        child: Card(
                            color: Colors.white,
                            child:
        ...
        floatingActionButton: FloatingActionButton(
         onPressed: (){
           Navigator.push(context, MaterialPageRoute(builder: (context){return AddMember();}));
         },
          child:

...
import 'package:chill_kid_intership/superAdminInterface/management/coach/add_coach.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title:Text('Entraineurs', style: TextStyle(color: Colors.white, fontSize: 16),),
          leading: IconButton(
            icon: Icon(
              Icons.arrow_back,
              color:

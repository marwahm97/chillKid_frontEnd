...
import 'package:chill_kid_intership/welcome_page_animation/core/constants/material_constants/material_constants.dart';
import 'package:chill_kid_intership/welcome_page_animation/features/welcome/welcome_event.dart';
import 'package:chill_kid_intership/welcome_page_animation/features/welcome/welcome_state.dart';
import 'package:chill_kid_intership/welcome_scree.dart';
import 'package:chill_kid_intership/welcome_page_animation/widgets/animated_clip_transition_widget.dart';
import 'package:chill_kid_intership/welcome_page_animation/widgets/animated_logo.dart';
import 'package:chill_kid_intership/welcome_page_animation/widgets/intro_text_widget.dart';
import 'package:chill_kid_intership/welcome_page_animation/widgets/shadow_image.dart';
...
class _WelcomePageState extends BaseState<WelcomePage, BaseBloc> with TickerProviderStateMixin {
        ...
        AnimatedPositionedLogo(
            child: SafeArea(
                child: Padding(
                   ...
                   child: GradientText('Chill Kid', style: Theme.of(context).textTheme.headline5, colors: [Colors.pink[300], Colors.purple[400],Colors.blue[400] ]),
        )))
      ],
    );
  }
  ...
  Widget pageViewer() {
    ...
    return PageView(controller: pageController, children: [
      getPage('assets/pic10.png', duration: Duration(milliseconds: 2000)),
      getPage('assets/picGymn.png',
          duration: Duration(milliseconds: 2000), initialDelay: Duration.zero),
      getPage('assets/pic9.png',
          duration: Duration(milliseconds: 2000), initialDelay: Duration.zero, curve: Curves.fastLinearToSlowEaseIn),
    ]);
  }

  Column getPage(String imagePath, {Duration initialDelay,  Duration duration, Curve curve}) {
    return Column(

...
import 'package:chill_kid_intership/adminInterface/management/coach/listCoach.dart';
...
class coachDetail extends StatefulWidget {
  ...
  User user;
  coachDetail(this.user);
  @override
  _coachDetailState createState() => _coachDetailState(this.user);
}

class _coachDetailState extends State<coachDetail> {
  User user;

  _coachDetailState(this.user);



  Future<User> deleteCoach(String username) async {
                                    ...
                                    builder: (context)=> AlertDialog(
                                      ...
                                      actions: <Widget>[
                                        FlatButton(
                                          ...
                                          onPressed: (){
                                            deleteCoach(this.user.username);
                                          },
                                        ),
                                        FlatButton(
